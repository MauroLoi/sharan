  ...
  return (
    <>
      <div className="flex">
        ...
        <div className="w-full h-screen border-solid border-[1px] border-slate-500 bg-slate-50">
          <h2 className="p-10 text-center">Sharan titolo</h2>
          <h4 className=" pb-10 text-center">motto</h4>
          <p className="text-center">breve descrizone</p>
          <img src="" alt="" />
        </div>
