const Footer = () => {
  return (
    <>
      <footer className=" bg-secondary flex justify-between p-4 px-9 max-h-40">
        <div className="flex flex-col w-72">
          <div className="flex items-center">
            <svg className="" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 2048 2048" width="65" height="65">
            ...
            <h5 className="text-slate-50">Sharan</h5>
          </div>
        ...
        <div className="flex flex-col justify-center text-center pr-40">
          <h5 className="text-slate-50 pb-5">Pagine</h5>
          <ul className="hover:cursor-pointer flex flex-row gap-2">
        ...
        <div className="flex flex-col justify-center items-center">
          <h5 className="text-slate-50 pb-3">Social</h5>
