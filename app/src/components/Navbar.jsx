...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="flex items-center w-full bg-secondary max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4 p-4">
                    {
                        auth.token == null ? (
                            <>
                                <div>
                                    <Link to="/accedi" className="text-slate-50">Accedi</Link>
                                </div>
                                <div>
                                    <Link to="/registrati" className="text-slate-50">Registrati</Link>
                                </div>
                            </>
                        ) : (
                            <>
